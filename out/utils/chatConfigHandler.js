    ...
    async handleMemoryCommand(command) {
        ...
        switch (command.action) {
            ...
            case 'add':
                ...
                await this.aiAgent.rememberImportantNote('User Note', command.value, ['user_input', 'manual']);
            ...
            case 'remove':
                ...
                await this.aiAgent.rememberImportantNote('Ignore Previous', `User requested to forget/ignore: ${command.query}`, ['ignore', 'removal', 'user_request']);
